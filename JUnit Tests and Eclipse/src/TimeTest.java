/**
 * Tests various methods of the Time class to verify that all functions work in multiple ways
 */
...
public class TimeTest {
	...
	public void testSecondsException() {
		Time time = new Time(12, 25, 60);
	}
	
	@Test (expected=IndexOutOfBoundsException.class)
	public void testMinutesException() {
		Time time = new Time(12, 61, 24);
	}
	
	@Test (expected=IndexOutOfBoundsException.class)
	public void testHoursException() {
		Time time = new Time(25, 25, 53);
	}
	...
	public void testCompareToTrue() {
		...
		assertTrue("Same Types", time1.compareTo(time2)==1);
	}
	@Test
	public void testCompareToFalse() {
		Time time1 = new Time(11, 10, 10);
		Time time2 = new Time(10, 10, 10);
		assertTrue("Different Types", time1.compareTo(time2)==0);
